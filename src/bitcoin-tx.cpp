...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s bimbocoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  bimbocoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded bimbocoin transaction") + "\n" +
              "  bimbocoin-tx [options] -create [commands]   " + _("Create hex-encoded bimbocoin transaction") + "\n" +
              "\n";
