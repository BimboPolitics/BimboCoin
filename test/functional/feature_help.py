...
"""Verify that starting bimbocoin with -h works as expected."""
import subprocess
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start bimbocoin with -h for help text")
        ...
        self.log.info("Start bimbocoin with -version for version information")
